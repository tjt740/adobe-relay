export default {
  ...
  profile: {
    ...
    avatar: {
      ...
      description: 'Upload an avatar image. Static uploads are compressed to 2MB before saving.',
      uploadAction: 'Upload image',
      uploadHint: 'Static uploads are compressed to 2MB when possible. GIF uploads must already be within 2.5MB.',
      ...
      gifTooLarge: 'GIF avatars must already be 2.5MB or smaller',
      compressTooLarge: 'Unable to compress this image below 2MB. Try a smaller image.',
