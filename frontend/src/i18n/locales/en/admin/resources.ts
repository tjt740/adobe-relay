export default {
    ...
    proxies: {
      clash: {
        "hideURL": "Hide URL",
        "showURL": "Show URL",
        "previewing": "Fetching nodes…",
        "previewHint": "Downloading the subscription and reading node information. Please wait.",
        "loadingHint": "Loading the saved subscription and runtime status.",
        "savingHint": "Updating node configurations and assigning proxy endpoints. Please wait.",
        "testProgress": "Node test progress",
        "nodeList": "Nodes",
        "nodeInfo": "Node / server address",
        "searchNodes": "Search name, protocol or address",
        "noMatches": "No matching nodes",
        "emptyTitle": "No node information yet",
        "totalNodes": "Total nodes",
        "previewData": "Current subscription preview",
        "savedData": "Saved node configurations",
        "protocolCount": "Protocols",
        "protocolHint": "Protocols in this subscription",
        "assignedNodes": "Imported & enabled",
        "assignedHint": "Available for account assignment",
        "healthyNodes": "Healthy nodes",
        "testedCount": "{count} tested this session",
        "assigned": "Imported",
        "nodeTesting": "Testing…",
        "testAfterImport": "Import to test",
        "queued": "Queued",
        "testComplete": "Test complete: {success} healthy, {failed} failed.",
        "title": "Clash subscription",
        "description": "Import a Clash subscription and assign a stable proxy endpoint to each selected node for accounts and audit requests.",
        "ready": "Runtime ready",
        "unavailable": "Runtime not ready",
        "setupHint": "Start and configure Mihomo using deploy/clash/README.md.",
        "current": "Current subscription:",
        "updated": "Last import:",
        "url": "Clash subscription URL",
        "keepURL": "Leave blank to reuse the saved URL; enter a new URL to replace it",
        "urlPlaceholder": "Paste a Clash YAML subscription URL",
        "replaceHint": "The URL is visible by default; use the eye icon to hide it. Import to save changes, and preview again after replacing the URL.",
        "preview": "Preview / refresh",
        "nodeCount": "{count} nodes",
        "selectedCount": "{count} selected",
        "selectAll": "Select all",
        "selectNone": "Deselect all",
        "test": "Test imported nodes",
        "testing": "Testing {done}/{total}",
        "assignment": "Import status / proxy endpoint",
        ...
        "imported": "Subscription saved. {count} nodes are available for assignment."
},
