export default {
    ...
    proxies: {
      clash: {
        ...
        "showURL": "显示链接",
        "previewing": "正在获取节点…",
        "previewHint": "正在下载订阅并解析节点，请稍候。",
        "loadingHint": "正在读取已保存的订阅及运行状态。",
        "savingHint": "正在更新节点配置并分配代理入口，请稍候。",
        "testProgress": "节点测试进度",
        "nodeList": "节点列表",
        "nodeInfo": "节点 / 服务器地址",
        "searchNodes": "搜索名称、协议或地址",
        "noMatches": "没有匹配的节点",
        "emptyTitle": "还没有节点信息",
        "totalNodes": "节点总数",
        "previewData": "本次订阅预览",
        "savedData": "已保存的节点配置",
        "protocolCount": "协议类型",
        "protocolHint": "订阅中的协议种类",
        "assignedNodes": "已导入启用",
        "assignedHint": "可分配给账号使用",
        "healthyNodes": "测试可用",
        "testedCount": "本次已测试 {count} 个",
        "assigned": "已导入",
        "nodeTesting": "测试中…",
        "testAfterImport": "导入后可测试",
        "queued": "等待测试",
        "testComplete": "测试完成：{success} 个可用，{failed} 个失败。",
        "title": "Clash 订阅",
        "description": "导入 Clash 订阅，为所选节点分配固定代理入口，供账号和审计请求使用。",
        "ready": "运行服务已就绪",
        "unavailable": "运行服务尚未就绪",
        "setupHint": "请先按 deploy/clash/README.md 启动并配置 Mihomo 运行服务。",
        "current": "当前订阅：",
        "updated": "最近导入：",
        "url": "Clash 订阅链接",
        "keepURL": "留空使用已保存的订阅；输入新链接可更换订阅",
        "urlPlaceholder": "粘贴 Clash YAML 订阅链接",
        "replaceHint": "链接默认可见，可点击眼睛图标隐藏；导入后保存，更换链接后请重新预览。",
        "preview": "预览 / 刷新订阅",
        ...
        "selectNone": "取消全选",
        "test": "测试已导入节点",
        "testing": "正在测试 {done}/{total}",
        "assignment": "导入状态 / 代理入口",
        "health": "活性 / 延迟",
        "pending": "待导入",
        "disabled": "已停用",
        "empty": "粘贴订阅链接并预览，选择要导入的节点。",
        "importHint": "导入后，同名节点保留代理编号和账号绑定；未选中或已消失的旧节点会停用。取消全选会停用全部订阅节点。",
        "useHint": "导入后，在账号的代理选择中搜索“Clash · 节点名”即可分配；也可在 IP 管理中测试连接和检测出口 IP。测试使用当前已导入的配置。",
        "import": "导入所选 / 保存更换",
        "importing": "正在导入…",
        "failed": "操作失败，请重试",
        "notTested": "未测试",
        "unhealthy": "不可用",
        "imported": "已保存订阅，{count} 个节点可用于分配。"
},
