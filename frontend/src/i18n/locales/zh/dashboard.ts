export default {
  ...
  profile: {
    ...
    avatar: {
      title: '资料头像',
      description: '仅支持上传头像图片；静态图片会自动压缩到 2MB 以内后再保存。',
      uploadAction: '上传图片',
      uploadHint: '上传图片时会自动压缩静态图片到 2MB 以内，GIF 需自行控制在 2.5MB 以内',
      uploadRequired: '请先上传头像图片',
      saveSuccess: '头像已更新',
      deleteSuccess: '头像已删除',
      invalidType: '请选择图片文件',
      gifTooLarge: 'GIF 头像必须在 2.5MB 以内',
      compressTooLarge: '无法将图片压缩到 2MB 以内，请换一张更小的图片',
